...
export type SingleKeyObject<ObjectType> =
	IsUnion<keyof ObjectType> extends true
		? never
<<<<<<< HEAD:node_modules/create-wdio/node_modules/type-fest/source/single-key-object.d.ts
		: IfEmptyObject<ObjectType, never, ObjectType>;
=======
		: If<IsEmptyObject<ObjectType>, never, ObjectType>;

export {};
>>>>>>> Abdul_Rehman:node_modules/@appium/base-driver/node_modules/type-fest/source/single-key-object.d.ts
