...
export type SingleKeyObject<ObjectType> =
	IsUnion<keyof ObjectType> extends true
		? never
<<<<<<< HEAD:node_modules/read-pkg-up/node_modules/type-fest/source/single-key-object.d.ts
		: IfEmptyObject<ObjectType, never, ObjectType>;
=======
		: If<IsEmptyObject<ObjectType>, never, ObjectType>;

export {};
>>>>>>> Abdul_Rehman:node_modules/@appium/support/node_modules/type-fest/source/single-key-object.d.ts
